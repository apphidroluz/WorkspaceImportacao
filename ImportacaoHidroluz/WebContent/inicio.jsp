...
<html>
  ...
  <head>
	...
	<meta name="google-signin-client_id" content="814156775949-ltn7105ab0u3fhapiusagvku8rg02i9h.apps.googleusercontent.com">
	...
	<div class="modal-dialog" style="margin-top: 10px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title text-center" id="myModalLabel">Acesso ao Painel de Importação</h3>
			</div>
			...
			<div class="modal-body">
				<form method="post" action="Controle?cmd=logar">
					...
					<div class="modal-footer">
						<input value="Acessar" type="submit" class="form-control btn btn-danger" style="color: white">
					</div>
